...
<div class="morebt">
 ...
 <div class="cztable">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <c:forEach  items="${deployment}" var="d">
                <tr align="center">
                    ...
                    <td><a href="activiti/delete?deploymentid=${d.id}">删除</a></td>
                </tr>
            </c:forEach>
            </tbody>
        </table>
     ...
     <table width="100%" border="0" cellspacing="0" cellpadding="0">
         ...
         <c:forEach items="${processDefine}" var="pro">
         <tr style="height: 25px" align="center">
             ...
             <th scope="col"><a href="activiti/show?deploymentId=${pro.deploymentId}&resourceName=${pro.diagramResourceName}">查看流程图</a></th>
         </tr>
         </c:forEach>
         </tbody>
     </table>
     ...
     <form action="activiti/deploy" method="post" enctype="multipart/form-data" >
     <table width="80%">
         <tr>
